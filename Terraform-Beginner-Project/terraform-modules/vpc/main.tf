...
# use data source to get list of all avalablility zones in region
...
resource "aws_subnet" "public_subnet_az1" {
  ...
  map_public_ip_on_launch = true # any resource that launch in this subnet has public ip address
...
# create route table and add public route (0.0.0.0)
